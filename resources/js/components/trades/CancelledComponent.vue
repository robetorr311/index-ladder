<template>
  <div class="card">
   <div class="card-header"><h5 class="card-title"><i class="fas fa-handshake"></i> Trades Cancelled</h5></div>
    <div class="card-body">
...
<script>
    export default {
        ...
        mounted() {
            axios.get(localStorage['URLroot'] + '/GetCancelled').then(response => (this.SelectedValues(response.data)));
        },        
    }
</script>