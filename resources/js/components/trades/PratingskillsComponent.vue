<template>
   <div class="chart-container">
     <canvas id="myPRatingSkills"></canvas>
   </div>
</template>
<script>
    ...
    data() {
      ...
      methods: {
        chartConstructor(chartType, chartData, chartOptions) {
          const chartElement = $('#myPRatingSkills');
      ...
      mounted() {
        axios.get(localStorage['URLroot'] + '/GetUSkillRating/' + this.UserValue).then(response => (this.GetSkillRating(response.data)));
      },          
  }
</script>