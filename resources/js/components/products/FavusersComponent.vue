<template>
  <div class="card">
    <div class="card-header"><h5 class="card-title"><i class="fas fa-users"></i> Traders that match with your favorites</h5></div>
    <div class="card-body">
      <div class="row">
    ...
    export default {
        data() {
            return {
                ...
                UrlMatch: localStorage['URLroot'] + '/products/matchusers',
            };
        },
        methods: {
          SetValues(response){
        ...
        mounted() {
            axios.get(localStorage['URLroot'] + '/GetUsersFavorites').then(response => (this.SetValues(response.data)));
        },        
    }
</script>