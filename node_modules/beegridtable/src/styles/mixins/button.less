...
.button-group-base(@btnClassName) {
    ...
    //& .@{btnClassName}-icon-only .bee-icon {
    //    font-size: 13px;
    //    position: relative;
    //    //top: 1px;
    //}
    //
    //&-large .@{btnClassName}-icon-only .bee-icon{
    //    font-size: 15px;
    //    //top: 2px;
    //}
    //
    //&-small .@{btnClassName}-icon-only .bee-icon{
    //    font-size: 12px;
    //    //top: 0;
    //}
    ...
    &-large {
        & > .@{btnClassName} {
            .button-size(
                @btn-height-large; @btn-padding-large; @btn-font-size-large;
                    @btn-border-radius
            );
        }
    }
    ...
    &-small {
        & > .@{btnClassName} {
            .button-size(
                @btn-height-small; @btn-padding-small; @btn-font-size;
...
.btn-square(@btnClassName) {
    ...
    .button-size(
        @btn-square-size; 0; @font-size-base + 2px; @btn-border-radius
    );
    &.@{btnClassName}-large {
        .square(@btn-square-size-large);
        .button-size(
            @btn-square-size-large; 0; @btn-font-size-large + 2px;
                @btn-border-radius
        );
    }
    &.@{btnClassName}-small {
        ...
        .button-size(
            @btn-square-size-small; 0; @font-size-base; @btn-border-radius
        );
    }
}
...
.btn() {
    ...
    user-select: none;
    .button-size(
        @btn-height-base; @btn-padding-base; @btn-font-size; @btn-border-radius
    );
...
.btn-default() {
 ...
 {
        .button-color(
            tint(@primary-color, 20%) ; white; tint(@primary-color, 20%)
        );
    }
    &:active,
    &.active {
        .button-color(
            shade(@primary-color, 5%) ; white; shade(@primary-color, 5%)
        );
    }
...
// Circle for Icon
.btn-circle(@btnClassName: bee-btn) {
    border-radius: @btn-circle-size;
...
// Group
.btn-group(@btnClassName: bee-btn) {
    .button-group-base(@btnClassName);
...
.btn-group-vertical(@btnClassName: bee-btn) {
    .button-group-vertical-base(@btnClassName);
